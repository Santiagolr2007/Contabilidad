...
class LedgerService:
    ...
    SECTIONS = {
        "datos_complementarios": ("Datos Complementarios", (
            ...
            field("responsable_interno", "Responsable interno"), field("observaciones", "Observaciones"),
        )),
        "servicio_presupuesto": ("Servicio y Presupuesto", (
            ...
            field("fecha_presupuesto", "Fecha del presupuesto"), field("concepto", "Concepto presupuestado", ("Alta inicial", "Abono mensual", "Liquidación mensual", "Presentación anual", "Regularización", "Fiscalización", "Moratoria / plan de pago", "Alta ARCA", "Alta IIBB", "Alta municipal", "Alta empleador", "Sueldos", "Casas particulares", "Societario", "Certificación", "Informe", "Consulta", "Otro")), field("tipo_honorario", "Tipo de honorario", ("Fijo mensual", "Fijo por trámite", "Por hora", "Por presentación", "Por empleado", "Por impuesto", "Por paquete", "Bonificado", "Sin cargo", "Otro")),
        ...
        "pagos": ("Pagos del Cliente", (
            ...
            field("medio_pago", "Medio de pago", ("Efectivo", "Transferencia", "Mercado Pago", "Débito", "Crédito", "Cheque", "Cuenta DNI", "MODO", "Otro")),
        ...
        "eventos": ("Tareas Eventos", (
            field("fecha", "Fecha"), field("area", "Área", ("ARCA", "IIBB", "Municipal", "Laboral", "Societario", "Contable", "Bancos", "Facturación", "Documentación", "Pagos", "Presupuesto", "Riesgos", "Otro")), field("tipo_evento", "Tipo de evento", ("Alta", "Baja", "Modificación", "Control", "Presentación", "Pago", "Intimación", "Fiscalización", "Requerimiento", "Pedido de documentación", "Recepción de documentación", "Consulta", "Reunión", "Llamada", "WhatsApp", "Email", "Recomendación profesional", "Regularización", "Recordatorio", "Otro")), field("descripcion", "Descripción"), field("responsable", "Responsable"), field("estado", "Estado", ("Pendiente", "En proceso", "Esperando cliente", "Esperando organismo", "Finalizado", "Vencido", "Cancelado", "No corresponde")), field("prioridad", "Prioridad", ("Baja", "Media", "Alta", "Urgente")), field("fecha_vencimiento", "Fecha vencimiento"), field("fecha_resolucion", "Fecha de resolución"), field("medio", "Medio"), field("documentacion_vinculada", "Documentación vinculada"), field("link", "Link"), field("proximo_paso", "Próximo paso"), field("alerta", "Alerta", ("Sí", "No")), field("observaciones", "Observaciones"),
        )),
        "vencimientos_legajo": ("Vencimientos", (
            field("organismo", "Organismo", ("ARCA", "ARBA", "AGIP", "COMARB", "Municipio", "IGJ", "DPPJ", "Ministerio de Trabajo", "Banco", "Estudio", "Otro")), field("impuesto_tramite", "Impuesto / trámite"), field("periodo", "Período"), field("fecha_vencimiento", "Fecha vencimiento"), field("tipo", "Tipo", ("Presentación", "Pago", "Renovación", "Recategorización", "Alta", "Baja", "Modificación", "Informe", "Control", "Reunión", "Respuesta a intimación", "Vencimiento de certificado", "Vencimiento contractual", "Otro")), field("estado", "Estado", ("Pendiente", "Presentado", "Pagado", "Vencido", "En proceso", "No corresponde", "A revisar")), field("responsable", "Responsable"), field("link", "Link al comprobante / presentación / carpeta"), field("particularidad", "Particularidad del cliente"), field("requiere_documentacion", "Requiere documentación", ("Sí", "No", "A revisar", "No corresponde")), field("documentacion_pendiente", "Documentación pendiente", ("Sí", "No", "Parcial", "No corresponde")), field("alerta", "Alerta", ("Sí", "No")), field("fecha_aviso", "Fecha de aviso al cliente"), field("medio_aviso", "Medio aviso", ("WhatsApp", "Email", "Llamada", "Presencial", "No avisado", "Otro")), field("observaciones", "Observaciones"),
        )),
    ...
    def summary(self, client_id: int) -> dict:
        ...
        tasks = self.database.query_one("SELECT COUNT(*) n FROM tareas WHERE cliente_id=? AND estado NOT IN ('finalizado','archivado','cobrado')", (client_id,))
        due = self.database.query_one("SELECT MIN(fecha_vencimiento) fecha FROM vencimientos WHERE cliente_id=? AND estado NOT IN ('pagado','presentado') AND fecha_vencimiento BETWEEN ? AND ?", (client_id, today, soon))
        ...
        return {
            ...
            "tareas_vencidas": len(overdue_ledger_tasks),
