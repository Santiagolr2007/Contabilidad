...
class ResponsibleInscriptoView(ttk.Frame):
    ...
    def __init__(self, parent, app) -> None:
        ...
        ttk.Button(controls, text="Importar datos ARCA", command=lambda: self.app.show_view("clientes", action="import_arca")).grid(row=1, column=1, sticky="w", padx=6, pady=(5, 0))
        ttk.Button(controls, text="Cambios manuales", command=self.manual_changes).grid(row=1, column=2, columnspan=2, sticky="w", padx=5, pady=(5, 0))
